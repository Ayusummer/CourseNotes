/*
 * @Author: your name
 * @Date: 2021-05-20 16:49:09
 * @LastEditTime: 2021-05-20 17:27:38
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \JuniorLesson_SecondTerm\EmbeddedSystem\Experiment\实验18-第9次实验-ADC实验\main-v1.1.1-电压放大调整.c
 */
#include "sys.h"
#include "delay.h"
#include "usart.h"
...
void draw_roll(u16 buffer[], u16 temp){
    ...
    while(!flag||!round){       //其实只要!flag就行
        ...
        if(round && (i==index%num_point_per_circle)) 
            flag=1;
    }//while(!flag||!round)
}
...
void clean_lcd(void){
    LCD_Fill(35, lcddev.height/2-210, 435, lcddev.height/2+80, WHITE);    
}
